...
def download_single_image(img_url: str, filename: str,
    ...
    try:
        ...
        if response.ok:
            ...
            img_path = filepath_fix_existing(
                directory_path, img_name, img_path)
...
class YandexImagesDownloader():
    ...
    def __init__(self,
                 driver=get_driver("Chrome", path=None),
    ...
    def download_images_by_page(self, keyword, filename, page, imgs_count,
        ...
        for img_url in img_hrefs:
            ...
            if self.pool:
                ...
                img_url_result = download_single_image(img_url, filename,
    ...
    def download_images_by_keyword(self, keyword, filename,
        ...
        for page in range(last_page + 1):
            ...
            page_result = self.download_images_by_page(keyword, filename, page,
                                                       imgs_count,
                                                       sub_directory)
